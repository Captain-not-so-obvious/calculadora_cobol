      ...
      ******************************************************************
       ...
       MAIN-PROCEDURE.
           ...
           EVALUATE WS-MODO
              WHEN = 1
                  PERFORM PROC-SOMAR THRU PROC-SOMAR-END
              WHEN = 2
                  PERFORM PROC-SUBTRAIR THRU PROC-SUBTRAIR-END
              WHEN = 3
                  PERFORM PROC-DIVIDIR THRU PROC-DIVIDIR-END
              WHEN = 4
       ...
       PROC-SOMAR.
           ...
           DISPLAY "A soma de " WS-NUM-1 " + " WS-NUM-2 " e " WS-RESULT.
       PROC-SOMAR-END.
